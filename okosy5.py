...
# ============================================================
#  1. Streamlit Secretsからの読み込みと初期設定 (★デプロイ用コード適用★)
# ============================================================
# load_dotenv() # Streamlit Cloudでは不要
...
# --- Authentication Setup (Vision API) - Relies on Firebase Admin SDK context ---
# os.environ["GOOGLE_APPLICATION_CREDENTIALS"] の設定は不要になります
...
# ============================================================
#  2. API Client Initializations (★デプロイ用コード適用★)
# ============================================================
